...
<body>
   ...
   <!-- content begin -->
    ...
    <!-- content end -->
    <!-- footer begin -->
    <footer class="text-center p-2 bg-primary-subtle footer fixed-bottom">
    <div>
        <a href="https://www.instagram.com/itsnayaz"
        ><i class="bi bi-instagram h2 p-2 text-dark"></i
        ></a>
        <a href="https://twitter.com/arrcticsnowzz"
        ><i class="bi bi-twitter h2 p-2 text-dark"></i
        ></a>
        <a href="https://wa.me/+6281575724795"
        ><i class="bi bi-whatsapp h2 p-2 text-dark"></i
        ></a>
    </div>
    <div>Naya Alifiah &copy; 2024</div>
    </footer>
    <!-- footer end -->
    <script
